...
header('Location: fshi_event.php');
}
?>
<!DOCTYPE html>
<head>
...
<body id="body">
    ...
    <div id="page">
        <ul class="header">
            ...
            <li><a class="active" href="fshi_event.php">Fshi Event</a></li>
            <li><a href="../ndrysho/ndrysho_event.php">Ndrysho Event</a></li>
        </ul>

	    <form action="fshi.php">
	        <table style="width:30%;float:left;">
	        	<tr><td>Shtypni datën e eventit: </td></tr>
	        	<tr><td><input type="text" name="data" placeholder="Data e eventit" required></td></tr>
	        	<tr><td><input type="submit" value="Fshi"></td></tr>
	        </table>
	   	</form>
    </div>
